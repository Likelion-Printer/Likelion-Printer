    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_time', models.DateTimeField(default=datetime.datetime(2020, 9, 24, 22, 1, 50, 485675))),
                ...
                ('printer_house', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='confirmations.printer_house')),
            ],
        ),
    ]
