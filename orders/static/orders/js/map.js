let mapContainer = document.getElementById('map_box'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.597329, 127.058850), // 지도의 중심좌표 - 한국외대
        level: 4 // 지도의 확대 레벨
    };
...
let marketPosition3 = new kakao.maps.LatLng(37.597062, 127.061180);//포컵스
...
let iwContent3 ='<div class="infowindow">포컵스</div>';
    iwPosition3 = new kakao.maps.LatLng(37.597062, 127.061180);     
